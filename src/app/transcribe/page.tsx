          ...
          <CardContent className='relative flex min-h-[500px] flex-col p-3 sm:min-h-[600px] sm:p-4 md:min-h-[700px] md:p-6 lg:min-h-[800px] lg:p-8 xl:p-10'>
                          ...
                          <div className='flex flex-col space-y-2'>
                            <div className='mb-4 flex items-center justify-between'>
                              ...
                              <div className='flex gap-2'>
                                <Button
                                  ...
                                  className='rounded-full text-xs hover:bg-zinc-800'
                                >
                            ...
                            <div className='relative'>
                              <Input
                                ...
                                className='w-full rounded-lg border-zinc-700 bg-zinc-800/50 focus:border-zinc-600'
                              />
                            </div>
                              ...
                              <div className='space-y-3'>
                                {filteredTranscripts.map((entry, index) => (
                                  <motion.div
                                    ...
                                    className='cursor-pointer rounded-lg bg-zinc-800/50 p-3 transition-colors hover:bg-zinc-700/50'
                                    onClick={() =>
            ...
            <div className='absolute right-0 bottom-0 left-0 rounded-b-2xl border-t border-zinc-800 bg-black p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10'>
              <form
                ...
                className='mx-auto flex w-full space-x-2 sm:w-5/6 md:w-4/5 lg:w-3/4 xl:w-2/3'
              >
                <Input
                  type='text'
                  value={videoUrl}
